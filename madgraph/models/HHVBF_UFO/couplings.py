# This file was automatically created by FeynRules 2.0.5
# Mathematica version: 9.0 for Mac OS X x86 (64-bit) (January 24, 2013)
# Date: Mon 25 Nov 2013 08:55:32
...
GC_54 = Coupling(name = 'GC_54',
                 value = '(C2V*ee**2*complex(0,1))/(2.*sw**2)',
                 order = {'C2V':1})
...
GC_85 = Coupling(name = 'GC_85',
                 value = 'C2V*ee**2*complex(0,1) + (C2V*cw**2*ee**2*complex(0,1))/(2.*sw**2) + (C2V*ee**2*complex(0,1)*sw**2)/(2.*cw**2)',
                 order = {'C2V':1})
...
GC_89 = Coupling(name = 'GC_89',
                 value = '-6*C3*complex(0,1)*lam*vev',
                 order = {'C3':1})
...
GC_93 = Coupling(name = 'GC_93',
                 value = '(CV*ee**2*complex(0,1)*vev)/(2.*sw**2)',
                 order = {'CV':1})
...
GC_101 = Coupling(name = 'GC_101',
                  value = 'CV*ee**2*complex(0,1)*vev + (CV*cw**2*ee**2*complex(0,1)*vev)/(2.*sw**2) + (CV*ee**2*complex(0,1)*sw**2*vev)/(2.*cw**2)',
                  order = {'CV':1})
